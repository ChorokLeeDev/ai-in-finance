"""
10,000-permutation test — decimal-unit convention, primary seed 28.
Addresses MC precision concern: 1,000-shuffle p=0.049 has SE~0.007.
10,000 shuffles reduce SE to ~0.002.
"""
...
def main():
    print("Loading FF data (decimal-unit)...")
    df = download_ff_data()
    # Convert to decimal
    factor_cols = ['MKT', 'SMB', 'HML', 'RMW', 'CMA', 'MOM']
    # Decimal conversion (data comes as percentage)
    ...
    result = {
        "description": "10,000-permutation OOS Elevated Granger test, decimal-unit convention, seed 28",
        "convention": "decimal_unit",
        "seed": PRIMARY_SEED,
        "n_perm": N_PERM,
    ...
    out_path = f"{RESULTS_DIR}/permutation_10k_decimal.json"
