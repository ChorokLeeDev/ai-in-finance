...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Otherwise $\rightarrow$ \textbf{vulnerable}: consider quarterly retraining (effect suggestive in this study; Holm-corrected $p=0.12$ over 3 tasks)
    \end{itemize}
