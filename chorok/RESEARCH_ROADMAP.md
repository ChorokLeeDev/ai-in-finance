...
- [ ] Prove: LOO ≠ Interventional (theoretically, not just empirically)
...
### Phase 4: Experiments
- [ ] Synthetic data with known ground truth causal effects
...
- [ ] Baselines:
  ...
  - SHAP - correlational
  - Bayesian ensemble - epistemic but not causal
  - Our method - causal
- [ ] Metrics:
  - Causal accuracy (on synthetic)
  - Calibration
...
**Current Status**: Phase 1 (Baseline) - 90% complete
**Next Phase**: Phase 2 (Theory) - 0% complete
