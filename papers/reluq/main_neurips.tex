...
\textbf{Datasets.} We evaluate on four RelBench datasets:
...
(3) \textbf{rel-amazon} (E-commerce): Associative domain with 2 FK groups;
(4) \textbf{rel-stack} (Q\&A Forum): Associative domain with 3 FK groups.

\textbf{Baselines.}
Feature-level attribution, correlation clustering, and random grouping.
...
(ERP, clinical trials: $\rho \geq 0.90$) but not for associative domains (Q\&A: $\rho = -0.50$).
