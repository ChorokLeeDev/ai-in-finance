...
\begin{table}[h]
\centering
\caption{Hierarchy comparison across methods}
\label{tab:hierarchy}
\begin{tabular}{lcccc}
\toprule
Method & Level 1 & Level 2 & Level 3 & Stable? \\
\midrule
Feature-level & -- & feature & value & N/A \\
Correlation & CORR\_GROUP & feature & value & \textbf{No} \\
\textbf{RelUQ (FK)} & FK group & feature & entity & \textbf{Yes} \\
\bottomrule
\end{tabular}
\end{table}
