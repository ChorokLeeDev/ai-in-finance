...
\begin{enumerate}
    \item \textbf{Empirical characterization}: We demonstrate that neural methods significantly outperform linear baselines on nonlinear data (threshold: +12.8\%, $p < 10^{-5}$; smooth: +23.2\%, $p=0.015$), while classical methods remain preferable for linear relationships.
