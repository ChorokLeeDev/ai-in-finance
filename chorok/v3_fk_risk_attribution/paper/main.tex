...
\begin{tabular}{lll}
\toprule
Dataset & Uncertainty Attribution Ranking & Error Impact Ranking \\
\midrule
SALT & [ITEM, SALESDOCUMENT, SALESGROUP, SHIPTOPARTY, SOLDTOPARTY] & [ITEM, SALESDOCUMENT, SALESGROUP, SOLDTOPARTY, SHIPTOPARTY] \\
Trial & [STUDY, FACILITY, ELIGIBILITY, SPONSOR, CONDITION, INTERVENTION] & [STUDY, FACILITY, ELIGIBILITY, CONDITION, SPONSOR, INTERVENTION] \\
Stack & [POST, ENGAGEMENT, USER] & [ENGAGEMENT, USER, POST] \\
\bottomrule
\end{tabular}
\end{table}
