...
Elevated & SMB $\to$ HML & $1.94 \times 10^{-4}$ & 3 & Marg.$^*$ \\
\midrule
Crisis & HML $\to$ SMB & $\mathbf{1.89 \times 10^{-5}}$ & 9 & \textbf{Yes} \\
Crisis & SMB $\to$ HML & $1.65 \times 10^{-1}$ & 4 & No \\
\bottomrule
\multicolumn{5}{@{}l@{}}{\footnotesize $^*$Survives $\alpha{=}0.01$ but not Bonferroni; weak OOS support.}
\end{tabular}
\end{table}
...
\url{https://github.com/ChorokLeeDev/ai-in-finance}.
